...
const Result = () => {
  ...
  console.log(LiberalArts);
  console.log(SocialSciences);
  console.log(NaturalScience);
  console.log(Engineering);
  console.log(Music);
  console.log(ArtAndDesign);
  console.log(Education);
  console.log(BusinessAdministration);
  console.log(ScienceAndIndustry);
  ...
  return (
    <Fragment>
      ...
      <div className="resultWrapper">
        ...
        <div className="content">{result.goal}</div>
